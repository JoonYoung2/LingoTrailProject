...
const insertCheck = () => {
    ...
    let msg = "";
    fetch("/speak_question/language_insert_list",
        {
            method: "get"
        })
        .then(res => res.json())
        .then(result => {
            ...
            msg = `
            <form action="/speak_question/language_insert" method="post" id="formId">
...
const updateCheck = () => {
    ...
    fetch("/speak_question/language_update",
        {
            method: "post",
...
const deleteCheck = () => {
    ...
    fetch("/speak_question/language_delete",
        {
            method: "post",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify(data)
